...
public class ChartboostPlugin extends CordovaPlugin {
	...
	protected String TEST_APP_ID = "57eac1f143150f65fabd2c8b";
	protected String TEST_APP_SIGNATURE = "138656b45456c9c6bf074b40828f61ff381e7ba6";	
	//
	...
	private void _setUp(String appId, String appSignature) {
		...
		if (!validLicenseKey) {
			if (new Random().nextInt(50) <= 1) {//0~49					
